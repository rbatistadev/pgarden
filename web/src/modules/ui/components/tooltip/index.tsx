...
const TooltipProvider: React.ComponentType<TooltipPrimitive.TooltipProviderProps> =
...
const TooltipTrigger: React.ComponentType<TooltipPrimitive.TooltipTriggerProps> =
