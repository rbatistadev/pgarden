...
const config: Config = {
  content: ['./src/**/*.{ts,tsx}', './src/modules/ui/components/**/*.{ts,tsx}",'],
  theme: {
    extend: {
      animation: {
      ...
      colors: {
        ...
        focus: 'var(--pgarden-focus, #1982fc)',
        // error: "rgb(from var(--pgarden-error) r g b / <alpha-value>)",
        brandnew: 'var(--pgarden-brand, #038178)',
        primary: {
          DEFAULT: '#388e4a',
          foreground: '#fefefe',
        },
        destructive: {
          DEFAULT: '#FF6B6B', // A softer, coral-likFe red
          foreground: '#FFF5F5',
        },
        secondary: {
          DEFAULT: '#f1f5f9',
